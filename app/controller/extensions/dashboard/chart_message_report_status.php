<?php
	...
	class ControllerExtensionsDashboardChartMessageReportStatus extends \AppMVCSandrielArgentim\AppMVC\MVC\System\Classes\MVC\Controller {
	    
		public function index($data) {
			return $this->load_view('extensions/dashboard/chart_message_report_status_form', $this->secure->remove_tags($data, '<i>'));
		}
		...
		public function dashboard($data) {
            ...
            return $this->load_view('extensions/dashboard/chart_message_report_status_info', $this->secure->remove_tags($data));
		}
	}
